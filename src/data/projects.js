...
import perfumeStoreImg from '../assets/projects/perfume-store.png'

const projects = [
  {
    id: 1,
    title: "Perfume Store – Full-Stack E-commerce Platform",
    tech: "Laravel 12 + React (Inertia.js) + Tailwind CSS + MySQL + Stripe",
    tags: ["Laravel", "React", "Stripe"],
    date: "june 2026",
    type: "personal",
    description:
      "Built a production-oriented perfume e-commerce platform featuring Stripe payments, variant-based inventory, coupon management, queued email notifications, order snapshotting, and a transaction-based checkout architecture.",
    image: perfumeStoreImg,
    link: "", // add after deployment
    github: "https://github.com/Akshay1705/perfume-store",
  },
  {
    id: 2,
